...
# Corp-API 서버 시작
Write-Host "Starting Corp-API server..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$PSScriptRoot\corp-api'; venv\Scripts\activate; uvicorn app:APP --host 0.0.0.0 --port 8080 --reload"
...
Write-Host "- Corp-API: http://localhost:8080" -ForegroundColor Cyan
